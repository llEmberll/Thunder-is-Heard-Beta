...
public class Cache
{
    ...
    public static CacheItem GetBasePlayerObjectData(GameObject obj)
    {
        ...
        return table.GetById(entity.ChildId);
    }

    public static CacheItem GetObjectCoreData(GameObject obj)
    {
        Entity entity = obj.GetComponent<Entity>();
        if ( entity == null )
        {
